...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___cover'
  ...
  | 'childMdx___frontmatter___cover'
...
export type MetaDataQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'titleTemplate' | 'siteUrl' | 'twitter'>
...
export type AllPostsQuery = { allMdx: (
    ...
    & { nodes: Array<(
      ...
      & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'summary' | 'cover' | 'author' | 'tags' | 'slug' | 'date'>> }
    )> }
  ) };
