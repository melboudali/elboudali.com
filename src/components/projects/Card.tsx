...
const Links = ({ link, figmaLink, githubLink }: LinksProps) => (
  <ButtonsWrapper>
    {link && <DemoLink href={link} target="_blank" aria-label="Demo Link" rel="noreferrer">
    ...
    <GithubLink href={githubLink} target="_blank" link={link} figmaLink={figmaLink} aria-label="Github Link" rel="noreferrer">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
