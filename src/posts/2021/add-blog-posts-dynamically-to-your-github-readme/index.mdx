...
summary: "You can share information about yourself with the community on GitHub by creating a profile README. You can decide what information to include in this file, so you have full control over how you present yourself on GitHub."
...
You can share information about yourself with the community on [GitHub](https://github.com/) by creating a profile `README`.

You can decide what information to include in this file, so you have full control over how you present yourself on GitHub. Here are some examples of information that visitors may find interesting, fun, or useful in your README file.
...
Adding your profile readme section is quite simple. All you need to do is create a new repository with your GitHub username your-github-username/your-github-username and add a `README.md` file. When you create the repository, GitHub will display a message containing the `✨special ✨` repository.
...
However, for the sake of demonstration, i will use [my gatsby website](https://elboudali.com/) and [gatsby-plugin-feed](https://www.gatsbyjs.com/plugins/gatsby-plugin-feed/) to generate an `RSS feed`.
