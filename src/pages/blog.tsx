...
const Blog = ({
  ...
  const onListClick = () => listType !== "list" && setListType("list");
  const onGridClick = () => listType !== "grid" && setListType("grid");
      ...
      <PageTitleWrapper>
        ...
        {!!MDX.length && (
          <ListStyleWrapper listType={listType}>
            <button type="button" onClick={onListClick} aria-label="Choose-list-type">
            ...
            <button type="button" onClick={onGridClick} aria-label="Choose-list-type">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
